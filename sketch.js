...
function setup() {
	...
	packageSprite=createSprite(width/2, 80, 10,10,bounce);
	...
	groundSprite=createSprite(width/2, height-35, width,10, ground2);
	...
	//Create a Ground
	ground = Bodies.rectangle(width/2, 650, width, 10 , ground2 );
